...
public class MainActivity extends AppCompatActivity implements AsyncExpandableListViewCallbacks<String, News> {
    private static AsyncExpandableListView<String, News> mAsyncExpandableListView;
    ...
    private static class LoadDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (listviewRef.get() != null) {
                ...
                mAsyncExpandableListView.smoothScrollToPosition(mGroupOrdinal);
    ...
    public void bindCollectionItemView(Context context, RecyclerView.ViewHolder holder, int groupOrdinal, News item) {
        NewsItemHolder newsItemHolder = (MainActivity.NewsItemHolder) holder;
    ...
    public static class MyHeaderViewHolder extends AsyncHeaderViewHolder implements AsyncExpandableListView.OnGroupStateChangeListener {
        ...
        public void onGroupExpanded() {
            ...
            ivExpansionIndicator.setImageResource(R.mipmap.ic_arrow_up);
        }
        ...
        public void onGroupCollapsed() {
            mProgressBar.setVisibility(View.GONE);
            ivExpansionIndicator.setVisibility(View.VISIBLE);
            ivExpansionIndicator.setImageResource(R.mipmap.ic_arrow_down);
